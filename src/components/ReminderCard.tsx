...
const styles = StyleSheet.create({
  ...
  titulo: { ...textStyles.micro, fontFamily: fontFamily.serif, color: colors.text.primary },
  linha: { flexDirection: 'row', alignItems: 'center', gap: size.card.metaGap },
  meta: { ...textStyles.pico, color: colors.text.secondary, flexShrink: 1 },
  lugar: { fontFamily: fontFamily.medium, color: colors.text.primary },
  aqui: { ...textStyles.pico, fontFamily: fontFamily.semibold, color: colors.text.accent },
  ...
  hora: { ...textStyles.mini, fontFamily: fontFamily.medium, color: colors.text.primary },

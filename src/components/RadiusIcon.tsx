...
export function RadiusIcon({ lado = size.card.metaIcon, color = colors.icon.radius }: { lado?: number; color?: string }) {
  return (
    // a acessibilidade vai no View: o Svg da web repassaria estas props para o elemento do navegador
    <View accessibilityElementsHidden importantForAccessibility="no-hide-descendants" aria-hidden>
      <Svg width={lado} height={lado} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={1.6} strokeLinecap="round">

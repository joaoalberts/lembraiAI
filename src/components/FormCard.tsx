...
export function FormCard({ children, style, testID, onLayout }: { children: ReactNode; style?: StyleProp<ViewStyle>; testID?: string; onLayout?: (e: LayoutChangeEvent) => void }) {
  return <View testID={testID} onLayout={onLayout} style={[styles.cartao, style]}>{children}</View>;
}

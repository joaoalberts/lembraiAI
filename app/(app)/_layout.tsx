...
// `initialRouteName="novo"`: depois de entrar o Stack.Protected da raiz cai na rota inicial deste grupo, e o João quer o formulário de novo lembrete (só essa abertura; o endereço manda no resto).
